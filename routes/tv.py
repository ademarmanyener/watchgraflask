...
def tv_title_func_proc(function):
  ...
  if function == 'like_comment':
    ...
    get_comment_rate = tvTitleCommentRate.query.filter(and_(tvTitleCommentRate.idContent == get_content_id, tvTitleCommentRate.idTvSeason == get_tv_season_id, tvTitleCommentRate.idComment == get_comment_id, tvTitleCommentRate.idRateProfile == get_logged_profile().idProfile, tvTitleCommentRate.idRateAccount == get_logged_account().idAccount, tvTitleCommentRate.rateType == 'LIKE')).first()
    if get_comment_rate == None:
      if get_comment.idAddAccount == get_logged_account().idAccount and get_comment.idAddProfile == get_logged_profile().idProfile:
        ...
        select_dislike = tvTitleCommentRate.query.filter(and_(tvTitleCommentRate.idContent == get_content_id, tvTitleCommentRate.idTvSeason == get_tv_season_id, tvTitleCommentRate.idComment == get_comment_id, tvTitleCommentRate.idRateProfile == get_logged_profile().idProfile, tvTitleCommentRate.idRateAccount == get_logged_account().idAccount, tvTitleCommentRate.rateType == 'DISLIKE')).first()
        if select_dislike:
          select_dislike.drop()
...
def tv_watch_func_proc(function):
  ...
  if function == 'send_comment':
    ...
    if get_text:
      ...
      latest_comment =  tvComment.query.filter(and_(tvComment.idContent == get_content_id, tvComment.idTvSeason == get_tv_season_id, tvComment.idTvEpisode == get_tv_episode_id, tvComment.replyTo == '', tvComment.idAddProfile == get_logged_profile().idProfile, tvComment.idAddAccount == get_logged_account().idAccount)).order_by(tvComment.addDate.desc()).first()
      if latest_comment == None: return make_response(jsonify({'err_msg': 'Böyle bir yorum bulunamadı.'}))
  ...
  if function == 'like_comment':
    ...
    get_comment_rate = tvCommentRate.query.filter(and_(tvCommentRate.idContent == get_content_id, tvCommentRate.idTvSeason == get_tv_season_id, tvCommentRate.idTvEpisode == get_tv_episode_id, tvCommentRate.idComment == get_comment_id, tvCommentRate.idRateProfile == get_logged_profile().idProfile, tvCommentRate.idRateAccount == get_logged_account().idAccount, tvCommentRate.rateType == 'LIKE')).first()
    if get_comment_rate == None:
      if get_comment.idAddAccount == get_logged_account().idAccount and get_comment.idAddProfile == get_logged_profile().idProfile:
        return make_response(jsonify({'err_msg': 'Kendi profiliniz tarafından yapılan yorumları beğenemezsiniz.'}))
      else:
        ...
        # if the profile has disliked the comment, then drop it first
        select_dislike = tvCommentRate.query.filter(and_(tvCommentRate.idContent == get_content_id, tvCommentRate.idTvSeason == get_tv_season_id, tvCommentRate.idTvEpisode == get_tv_episode_id, tvCommentRate.idComment == get_comment_id, tvCommentRate.idRateProfile == get_logged_profile().idProfile, tvCommentRate.idRateAccount == get_logged_account().idAccount, tvCommentRate.rateType == 'DISLIKE')).first()
        if select_dislike:
          select_dislike.drop()
          return make_response(jsonify({'gave_like': 'Yorumu başarıyla beğendiniz!', 'took_dislike': 'OK'}))
